...
namespace ILRuntime.Runtime.Generated
{
    class CLRBindings
    {
        ...
        public static void GenerateBindingCode(ILRuntime.Runtime.Enviorment.AppDomain domain, string outputPath, bool deleteOld = true)
        {
            if (domain == null)
                return;
            if (!System.IO.Directory.Exists(outputPath))
...
namespace ILRuntime.Runtime.Generated
{
    class CLRBindings
    {
        ...
        static void CrawlAppdomain(ILRuntime.Runtime.Enviorment.AppDomain domain, Dictionary<Type, CLRBindingGenerateInfo> infos)
        {
            ...
            {
                if(type.FullName.Contains("RoleStateID"))
                {
                    int a = 0;
                }
