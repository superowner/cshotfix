...
{
    unsafe class GameDll_IPlayer_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(GameDll.IPlayer);
            args = new Type[]{};
        ...
        static StackObject* GetId_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            GameDll.IPlayer instance_of_this_method;
            instance_of_this_method = (GameDll.IPlayer)typeof(GameDll.IPlayer).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
