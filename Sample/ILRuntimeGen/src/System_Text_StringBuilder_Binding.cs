...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_Text_StringBuilder_Binding
    {
        ...
        static StackObject* Append_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Text.StringBuilder instance_of_this_method;
            instance_of_this_method = (System.Text.StringBuilder)typeof(System.Text.StringBuilder).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
