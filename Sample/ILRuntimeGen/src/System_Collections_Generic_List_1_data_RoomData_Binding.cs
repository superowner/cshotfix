...
{
    unsafe class System_Collections_Generic_List_1_data_RoomData_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(System.Collections.Generic.List<data_RoomData>);
            args = new Type[]{};
            ...
            args = new Type[]{typeof(data_RoomData)};
        ...
        static StackObject* get_Count_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Collections.Generic.List<data_RoomData> instance_of_this_method;
            instance_of_this_method = (System.Collections.Generic.List<data_RoomData>)typeof(System.Collections.Generic.List<data_RoomData>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        static StackObject* Add_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            data_RoomData item = (data_RoomData)typeof(data_RoomData).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
            ptr_of_this_method = ILIntepreter.Minus(__esp, 2);
            System.Collections.Generic.List<data_RoomData> instance_of_this_method;
            instance_of_this_method = (System.Collections.Generic.List<data_RoomData>)typeof(System.Collections.Generic.List<data_RoomData>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new System.Collections.Generic.List<data_RoomData>();
