...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_Canvas_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, set_planeDistance_2);
            args = new Type[]{typeof(System.Boolean)};
            method = type.GetMethod("set_overrideSorting", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_overrideSorting_3);
            args = new Type[]{typeof(System.String)};
            method = type.GetMethod("set_sortingLayerName", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_sortingLayerName_4);
        ...
        static StackObject* set_planeDistance_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
        ...
        static StackObject* set_overrideSorting_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
        ...
        static StackObject* set_sortingLayerName_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
